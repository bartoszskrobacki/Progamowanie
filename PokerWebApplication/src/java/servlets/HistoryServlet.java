...
public class HistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println();
            for(HistoryOfGame hist : game.getHistoryOfGamesList()){
                out.print(hist.getCard1() + ", ");
                out.print(hist.getCard2() + ", ");
                out.print(hist.getCard3() + ", ");
                out.print(hist.getCard4() + ", ");
                out.print(hist.getCard5() + ", ");
                out.print("Result is " +
                hist.getResult());
                out.println("<br />");
            }
