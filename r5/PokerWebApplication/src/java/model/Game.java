...
public class Game {
    ...
    private final List<HistoryOfGame> historyOfGames;
...
this.restart();
this.start();
HistoryOfGame newHistory;
newHistory = new HistoryOfGame(this.hand.ListofCards.get(0).getNameandColor(), this.hand.ListofCards.get(1).getNameandColor(), this.hand.ListofCards.get(2).getNameandColor(), this.hand.ListofCards.get(3).getNameandColor(), this.hand.ListofCards.get(4).getNameandColor(), this.getResult());
historyOfGames.add(0,newHistory);
